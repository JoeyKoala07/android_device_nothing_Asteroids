...
AB_OTA_PARTITIONS += \
    ...
    vendor \
    product
# Device has a real recovery partition; do NOT use recovery-as-boot
...
# Super / dynamic partitions (TODO: verify exact sizes)
...
# Backlight / brightness (required by OrangeFox)
TW_BRIGHTNESS_PATH    := "/sys/class/backlight/panel0-backlight/brightness"
TW_MAX_BRIGHTNESS     := 4095
TW_DEFAULT_BRIGHTNESS := 2048

# Security patch level hack (anti-rollback)
...
# TWRP / recovery configuration (used by OrangeFox too)
...
# Kernel / image layout extras (GKI)
