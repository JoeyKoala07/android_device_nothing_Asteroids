# BoardConfig for Nothing Phone 3a (A059)
...
BOARD_USES_AB := true
AB_OTA_PARTITIONS += boot vendor_boot init_boot dtbo

# Dynamic partitions
BOARD_SUPER_PARTITION_SIZE := 8388608000
BOARD_SUPER_PARTITION_GROUPS := asteroids_dynamic_partitions
BOARD_ASTEROIDS_DYNAMIC_PARTITIONS_PARTITION_LIST := system system_ext vendor product odm
